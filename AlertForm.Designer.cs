namespace Spotangles {
	partial class AlertForm {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "SPOT AVAILABLE";
			// 
			// label2
			// 
			...
			this.label2.Text = "The following class(es) have available spots";
			// 
			// classBox
			// 
			this.classBox.FormattingEnabled = true;
			this.classBox.Location = new System.Drawing.Point(25, 85);
			this.classBox.Name = "classBox";
			this.classBox.Size = new System.Drawing.Size(427, 160);
